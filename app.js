...
app.post('/enviar-correo', (req, res) => {
  ...
  if (botonSeleccionado === 'plomero') {
    mailOptions = {
      ...
      solicitado su ayuda para solucionarlo. El cliente se encuentra en la siguiente dirección: [dirección del cliente].
    ...
    mailOptions = {
      ...
      text:`
      Estimado/a [nombre del decorador/a],

      Espero que se encuentre bien. Me pongo en contacto con usted en calidad de representante 
      de Auxilium.

      El cliente ha solicitado sus servicios de decoración para su hogar, ubicado en la siguiente dirección: [dirección del cliente].
    ...
    mailOptions = {
      ...
      text: `
      Estimado/a [nombre del controlador/a de plagas],

      Espero que se encuentre bien. Me pongo en contacto con usted en calidad de representante
      de Auxilium.

      El cliente ha reportado un problema de plagas en su hogar y ha solicitado su ayuda para
      solucionarlo. Se encuentra en la siguiente dirección: [dirección del cliente].
    ...
    mailOptions = {
      from: 'auxilium.gestion777',
      to: 'alejandromarin203@gmail.com',
      subject: `Solicitud de servicio de reparación de aire acondicionado para el cliente ${username}`,
      text: `
      Estimado/a [nombre del reparador/a],
    ...
    mailOptions = {
      ...
      text: `
      Estimado/a [nombre del carpintero/a],

      Espero que se encuentre bien. Me pongo en contacto con usted en calidad de representante 
      de Auxilium.

      El cliente ha reportado un problema con un mueble en su hogar y ha solicitado 
      su ayuda para repararlo. El cliente se encuentra en la siguiente dirección: [dirección del cliente].
    ...
    mailOptions = {
      ...
      text: `
      Estimado/a [nombre del electricista],
    ...
    mailOptions = {
      ...
      text: `
      Estimado/a [nombre del pintor/a],

      Espero que se encuentre bien. Me pongo en contacto con usted en calidad de representante 
      de Auxilium.

      El cliente ha solicitado los servicios de un pintor para realizar trabajos en su 
      domicilio. La dirección del cliente es la siguiente: [dirección del cliente].
    ...
    mailOptions = {
      ...
      text: `
      Estimado/a [nombre del servicio de limpieza],

      Espero que se encuentre bien. Me pongo en contacto con usted en calidad de representante 
      de Auxilium.

      El cliente ha solicitado un servicio de limpieza en su hogar ubicado en la 
      siguiente dirección: [dirección del cliente]. 
    ...
    mailOptions = {
      ...
      text: `
      Estimado/a [nombre del albañil/a],

      Espero que se encuentre bien. Me pongo en contacto con usted en calidad de representante 
      de Auxilium.

      El cliente ha reportado un problema con una pared en su hogar y ha solicitado 
      su ayuda para solucionarlo. El cliente se encuentra en la siguiente dirección: [dirección del cliente].
